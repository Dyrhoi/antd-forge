...
By default, `useTable` uses server-side pagination where you handle pagination in your API. For smaller datasets, you can use **client-side pagination** where Ant Design's Table handles pagination from the full dataset.
